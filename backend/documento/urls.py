...
from .views import  DocumentosViewSet, ListaDocumentosPaginados, ListaDocumentosViewSet, ObtenerDocumentos, RecibirDocumentoViewSet
...
urlpatterns = [
    ...
    path('obtener-documento/',ObtenerDocumentos.as_view()),
    # path('buscar_por_empresa/',ListaDocumentosPaginados.as_view())
]